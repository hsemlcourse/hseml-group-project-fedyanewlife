...
**Целевая метрика:** RMSE, дополненная MAE и R²
- RMSE чувствительна к большим ошибкам, что будет важно для прогнозировании дохода
- MAE даст интерпритируемую среднюю ошибку в долларах
- R² покажет долю объяснённой дисперсии
